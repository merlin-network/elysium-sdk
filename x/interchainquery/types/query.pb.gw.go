...
var (
	pattern_QuerySrvr_Queries_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3, 1, 0, 4, 1, 5, 4}, []string{"elysium", "interchainquery", "v1beta1", "queries", "chain_id"}, "", runtime.AssumeColonVerbOpt(false)))
)
