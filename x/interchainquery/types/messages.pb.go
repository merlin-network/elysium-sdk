...
// source: elysium/interchainquery/v1beta1/messages.proto
...
func init() {
	proto.RegisterType((*MsgSubmitQueryResponse)(nil), "elysium.interchainquery.v1beta1.MsgSubmitQueryResponse")
	proto.RegisterType((*MsgSubmitQueryResponseResponse)(nil), "elysium.interchainquery.v1beta1.MsgSubmitQueryResponseResponse")
}

func init() {
	proto.RegisterFile("elysium/interchainquery/v1beta1/messages.proto", fileDescriptor_8334dd1e1e60b470)
}
...
func (c *msgClient) SubmitQueryResponse(ctx context.Context, in *MsgSubmitQueryResponse, opts ...grpc.CallOption) (*MsgSubmitQueryResponseResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/elysium.interchainquery.v1beta1.Msg/SubmitQueryResponse", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Msg_SubmitQueryResponse_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/elysium.interchainquery.v1beta1.Msg/SubmitQueryResponse",
	}
...
var _Msg_serviceDesc = grpc.ServiceDesc{
	ServiceName: "elysium.interchainquery.v1beta1.Msg",
	...
	Metadata: "elysium/interchainquery/v1beta1/messages.proto",
}
