...
var (
	pattern_Msg_SubmitQueryResponse_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3, 2, 4}, []string{"elysium", "interchainquery", "tx", "v1beta1", "submitquery"}, "", runtime.AssumeColonVerbOpt(false)))
)
