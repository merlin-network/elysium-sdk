...
// source: elysium/interchainquery/v1beta1/query.proto
...
func init() {
	proto.RegisterType((*QueryRequestsRequest)(nil), "elysium.interchainquery.v1beta1.QueryRequestsRequest")
	proto.RegisterType((*QueryRequestsResponse)(nil), "elysium.interchainquery.v1beta1.QueryRequestsResponse")
	proto.RegisterType((*GetTxWithProofResponse)(nil), "elysium.interchainquery.v1beta1.GetTxWithProofResponse")
}

func init() {
	proto.RegisterFile("elysium/interchainquery/v1beta1/query.proto", fileDescriptor_9bd62a9cc0c2e078)
}
...
func (c *querySrvrClient) Queries(ctx context.Context, in *QueryRequestsRequest, opts ...grpc.CallOption) (*QueryRequestsResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/elysium.interchainquery.v1beta1.QuerySrvr/Queries", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _QuerySrvr_Queries_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/elysium.interchainquery.v1beta1.QuerySrvr/Queries",
	}
...
var _QuerySrvr_serviceDesc = grpc.ServiceDesc{
	ServiceName: "elysium.interchainquery.v1beta1.QuerySrvr",
	...
	Metadata: "elysium/interchainquery/v1beta1/query.proto",
}
