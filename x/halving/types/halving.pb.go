...
// source: elysium/halving/v1beta1/halving.proto
...
func init() {
	proto.RegisterType((*Params)(nil), "elysium.halving.v1beta1.Params")
}

func init() {
	proto.RegisterFile("elysium/halving/v1beta1/halving.proto", fileDescriptor_8f1c43ef62adb2ba)
}
