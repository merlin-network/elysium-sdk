...
// source: elysium/epochs/v1beta1/query.proto
...
func init() {
	proto.RegisterType((*QueryEpochsInfoRequest)(nil), "elysium.epochs.v1beta1.QueryEpochsInfoRequest")
	proto.RegisterType((*QueryEpochsInfoResponse)(nil), "elysium.epochs.v1beta1.QueryEpochsInfoResponse")
	proto.RegisterType((*QueryCurrentEpochRequest)(nil), "elysium.epochs.v1beta1.QueryCurrentEpochRequest")
	proto.RegisterType((*QueryCurrentEpochResponse)(nil), "elysium.epochs.v1beta1.QueryCurrentEpochResponse")
}

func init() {
	proto.RegisterFile("elysium/epochs/v1beta1/query.proto", fileDescriptor_ff75786aa031dea4)
}
...
func (c *queryClient) EpochInfos(ctx context.Context, in *QueryEpochsInfoRequest, opts ...grpc.CallOption) (*QueryEpochsInfoResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/elysium.epochs.v1beta1.Query/EpochInfos", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *queryClient) CurrentEpoch(ctx context.Context, in *QueryCurrentEpochRequest, opts ...grpc.CallOption) (*QueryCurrentEpochResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/elysium.epochs.v1beta1.Query/CurrentEpoch", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Query_EpochInfos_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/elysium.epochs.v1beta1.Query/EpochInfos",
	}
...
func _Query_CurrentEpoch_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/elysium.epochs.v1beta1.Query/CurrentEpoch",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var _Query_serviceDesc = grpc.ServiceDesc{
	ServiceName: "elysium.epochs.v1beta1.Query",
	...
	Metadata: "elysium/epochs/v1beta1/query.proto",
}
